...
/* SD Card definitions: Change these to fit your application when using
   an SD-card-based physical layer                                   */
	...
	//PM
		...
		//SPI Configuration
		#define SPI_START_CFG_1     (PRI_PRESCAL_16_1 | SEC_PRESCAL_8_1 | MASTER_ENABLE_ON | SPI_CKE_ON | SPI_SMP_ON)
        ...
        ///scheda vecchia
            // Description: SD-SPI Chip Select Output bit
        	//#define SD_CS               LATEbits.LATE7
        	// Description: SD-SPI Chip Select TRIS bit
            //#define SD_CS_TRIS          TRISEbits.TRISE7

            ///vecchia scheda
            //#define SD_CS               LATCbits.LATC3
            //#define SD_CS_TRIS          TRISCbits.TRISC3

            #define SD_CS               LATGbits.LATG9
            #define SD_CS_TRIS          TRISGbits.TRISG9

            // Description: SD-SPI Card Detect Input bit
            //#define SD_CD               PORTEbits.RE6
            // Description: SD-SPI Card Detect TRIS bit
            //#define SD_CD_TRIS          TRISEbits.TRISE6
            ...
            // Description: The main SPI control register
            #define SPICON1             SPI2ACON
            // Description: The SPI status register
            #define SPISTAT             SPI2ASTAT
            // Description: The SPI Buffer
            #define SPIBUF              SPI2ABUF
            // Description: The receive buffer full bit in the SPI status register
            #define SPISTAT_RBF         SPI2ASTATbits.SPIRBF
            // Description: The bitwise define for the SPI control register (i.e. _____bits)
            #define SPICON1bits         SPI2ACONbits
            // Description: The bitwise define for the SPI status register (i.e. _____bits)
            #define SPISTATbits         SPI2ASTATbits
            // Description: The enable bit for the SPI module
            #define SPIENABLE           SPI2ACONbits.ON
