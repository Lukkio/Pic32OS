...
#include "../Header/Pic32/FSconfig.h"
#include "../Header/FSDefs.h"
#include "stddef.h"

#ifdef USE_SD_INTERFACE_WITH_SPI
    #include    "../Header/SD-SPI.h"
#endif
...
***************************************************************************/
typedef struct{
    char Listaa[30][16];// lista di 12x12
    unsigned char IsDir[30];//é una cartella? a 1 si.
    char NFile;//n di file/cartelle caricate nella lista
}FileList;
