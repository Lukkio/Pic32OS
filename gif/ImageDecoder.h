...
#include "../gif/ImageDecoderConfig.h"
...
#define IMG_SCREEN_HEIGHT        (GetMaxY()+1)
    ...
    //Originale
       ...
       #define IMG_vSetColor(r, g, b)  coloregif=RGB16(r,g,b)
       #define IMG_vSetColor565(color)  coloregif=color
       #define _PutPixel(x, y)          LCD_Pixel(x, y,coloregif)
#else
